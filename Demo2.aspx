...
<body>
    <div class="row">
        <div class="col-md-8">
            <h6>
                <p>
                    <b>HTML page showing single fingerprint scanning.   You can control certain aspects of fingerprint capture data retrieved using parameters namely timeout, quality, template format.</b>
                </p>
            </h6>
            ...
            <tr>
                <td class="auto-style2" align="right" valign="top">
               	    <b>Input parameters</b> <br><br>
		                ...
		                Template Format <select id="tformat" > <option> ISO <option> ANSI </select> <br><br>
                </td>
